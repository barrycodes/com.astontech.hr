...
<div class="wrapper">
    ...
    <div id = "main-wrapper" class="col-sm-9">
        <div class="col-sm-8">
            <form:form cssClass="form-horizontal" modelAttribute="employeeVo" action="/admin/employee/update" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <form:input path="title" type="text" class="form-control" id="inputTitle" placeholder="Title" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputFirstName" class="col-lg-3 control-label">First Name</label>
                    <div class="col-lg-9">
                        <form:input path="firstName" type="text" class="form-control" id="inputFirstName" placeholder="First" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputMiddleName" class="col-lg-3 control-label">Middle Name</label>
                    <div class="col-lg-9">
                        <form:input path="middleName" type="text" class="form-control" id="inputMiddleName" placeholder="Middle" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputLastName" class="col-lg-3 control-label">Last Name</label>
                    <div class="col-lg-9">
                        <form:input path="lastName" type="text" class="form-control" id="inputLastName" placeholder="Last" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputDisplayFirstName" class="col-lg-3 control-label">Display First Name</label>
                    <div class="col-lg-9">
                        <form:input path="displayFirstName" type="text" class="form-control" id="inputDisplayFirstName" placeholder="leave blank if none" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <form:input path="birthDate" type="date" class="form-control" id="inputBirthDate" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputSsn" class="col-lg-3 control-label">SSN</label>
                    <div class="col-lg-9">
                        <form:input path="ssn" type="text" class="form-control" id="inputSsn" placeholder="SSN" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputHireDate" class="col-lg-3 control-label">Hire Date</label>
                    <div class="col-lg-9">
                        <form:input path="hireDate" type="date" class="form-control" id="inputHireDate" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputTermDate" class="col-lg-3 control-label">Term Date</label>
                    <div class="col-lg-9">
                        <form:input path="termDate" type="date" class="form-control" id="inputTermDate" />
                    </div>
                </div>
                <div class="form-group">
