    ...
    <div id = "main-wrapper" class="col-sm-9">
        <div class="col-sm-8">
            <form:form cssClass="form-horizontal" modelAttribute="vehicleVo" action="/admin/vehicle/update" method="post">
                ...
                <div class="form-group">
                    <label for="inputPurchasePrice" class="col-lg-3 control-label">Purchase Price</label>
                    <div class="col-lg-9">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control" id="inputVehicleModel" name="vehicleModelId">
                            <option name="vehicleModelId" value="0">--Select Model--</option>
                            <c:forEach var="vehicleModel" items="${vehicleModels}">
                                <c:choose>
                                    <c:when test="${vehicleModel.id==vehicleVo.vehicleModel.id}">
                                        <option name="vehicleModelId" value="${vehicleModel.id}" selected>
                                            ${vehicleModel.vehicleMake.vehicleMakeName} ${vehicleModel.vehicleModelName}
                                        </option>
                                    </c:when>
                                    <c:otherwise>
                                        <option name="vehicleModelId" value="${vehicleModel.id}">
                                            ${vehicleModel.vehicleMake.vehicleMakeName} ${vehicleModel.vehicleModelName}
                                        </option>
                                    </c:otherwise>
                                </c:choose>
